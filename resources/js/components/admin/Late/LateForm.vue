<template>
    ...
    >
        <label for="siswa" class="font-weight-bold"> Siswa : </label>
        <v-autocomplete
            class="mb-4"
        ...
        <label for="bukti" class="font-weight-bold"> Bukti : </label>
        <v-text-field
            class="mb-4"
            v-model="late.bukti"
            id="bukti"
    ...
    methods: {
        ...
        getDataLate() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.late.date_time_late =
                        response.data.data.date_time_late;
        ...
        submit() {
            ...
            if (this.valid) {
                ...
                formData.append("student_id", this.late.student_id);
                formData.append("date_time_late", this.late.date_time_late);
                formData.append("information", this.late.information);
                if (this.late.bukti instanceof File) {
                    formData.append("bukti", this.late.bukti);
                }

                if (this.lateUri) {
                    axios
                        .put(this.formUri, formData, {
                            headers: {
